...
import { FaMapMarkerAlt, FaEnvelope, FaPhone, FaUsers, FaEdit, FaTrash, FaArrowLeft, FaPlus } from 'react-icons/fa';
...
const CenterDetailPage = () => {
  ...
  const fetchAvailableStudents = async () => {
    ...
    try {
      ...
      // Filter out students already enrolled in this center
          ...
          {center.enrolledStudents.length === 0 ? (
            <div className="text-center py-10 bg-gray-50 rounded-lg">
              ...
              <p className="text-gray-500">
                This center doesn't have any enrolled students yet.
              </p>
            </div>
          ) : (
